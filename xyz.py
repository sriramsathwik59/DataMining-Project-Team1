...
# If necessary, adjust the model or preprocessing to get closer to 70% accuracy
...
# Load the dataset
data = pd.read_csv('updated.csv')  # Replace with your file path
...
# Define predictor variables and target variable
X = data.drop('electric vehicle type', axis=1)  # Drop the target variable
...
# Adjust the model or data processing steps to get closer to 70% accuracy
